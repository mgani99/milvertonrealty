...
const String userDashboardRoute = "userDashboard";
const String unitSetupScreen = "unitSetup";
const String propertySetupScreen = "propertySetupScreen";
const String propertyViewRoute = "propertyViewRoute";
const String unitPictureScreenRoute = "unitPictureScreen";
const String addTenantLeadViewRoute ="addTenantLeadViewRoute";
const String signUpScreenRoute = "signup";
const String newUserSetupRoute = "new_user";
const String profileSetupScreenRoute = "profile_setup";
const String repairScreenRoute = "repair_screen";
